                  ...
                  children: [
                      ...
                      child: ClipRect(
                        child: OverflowBox(
                          ...
                          child: progress == 0
                              ...
                              : _DrawerPanel(
                                  animation: _controller.menuController,
                                  onItemSelected: _controller.selectMenuItem,
                                ),
                        ),
                      ),
                    ),
                    Expanded(
                      child: Stack(
                        children: [
                          Positioned.fill(
                            child: _HomeContent(controller: _controller),
                          ),
                          if (progress > 0)
                            Positioned.fill(
                              child: IgnorePointer(
...
class _DrawerPanel extends StatelessWidget {
  const _DrawerPanel({required this.animation, required this.onItemSelected});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          CollapseMenu(animation: animation, onItemSelected: onItemSelected),
        ],
      ),
    );
  }
